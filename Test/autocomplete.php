...
google.maps.event.addDomListener(window, 'load', initialize);
  ...
  <form method="post" action="#">
    <input name="a" id="pac-input" class="controls" type="text"
        placeholder="Enter a location">
    <input name="b" id="pac-input" class="controls" type="text"
        placeholder="Enter a location">
...
if(isset($_POST['a'])){echo getDistance($_POST['a'],$_POST['b']);}
    function getDistance($adresse1,$adresse2) {
      ...
      return 'distanceEnMetres = '.$distance.'<br/>dureeEnSecondes = '.$duree.'<br/>adresseDepart = '.$root->route->leg->start_address.'<br/>adresseArrivee = '.$root->route->leg->end_address;
    }
function dist($a, $b){
